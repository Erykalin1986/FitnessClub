...
static MembershipFactory GetFactory(string membershipType) => membershipType.ToLower() switch
{
    "g" => new GymMembershipFactory(100, "Basic membership"),
    "p" => new GymMembershipFactory(250, "Good price membership"),
    "t" => new GymMembershipFactory(400, "Best for professionals"),
    _ => null
};